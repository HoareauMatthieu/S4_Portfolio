    ...
    <div class="-mb-16 h-screen">
      ...
      <div class="flex justify-between">
        <div class="animate__animated animate__fadeIn p-4 text-sm">
          <p>Alpha Ghetti 11/2022</p>
        </div>

        <div class="p-4 text-sm">
          <p class="animate__animated animate__fadeIn text-right uppercase">Rebranding</p>
        </div>
      </div>
    </div>
      ...
      <div class="flex flex-col items-center">
        ...
        <div class="flex w-11/12 flex-col justify-between">
          <p class="reveal mt-6 text-justify text-xs transition-opacity duration-500">
            During my second third semester at Vanier in Montreal, we had the mission of redesigning the Alpha Ghetti can, a tomato sauce
            letter-shaped pasta can. My main objective was to give it a more modern look than the existing can, the challenge was to succeed
            in playing with a typogrpahy to represent the pasta, while keeping a tasty aspect to attract the consumer. So I went for the use
            of red and yellow colors, symbolizing the color of tomato sauce and pasta, by setting up an illustration playing with the
            concept of pasta in the form of letter. There was a lot of typographic play to put in place (especially at the level of the
            space of each letter on the design of the can) to keep the essence of the basic concept while adapting it to a more current
            design.
          </p>
        </div>
      </div>
      ...
      <div class="mt-24 flex flex-col">
        <div class="flex w-full flex-row-reverse items-center gap-6">
          ...
          <p class="reveal mt-6 w-1/2 px-3 text-justify text-xs duration-500">
            I decided to use a typography reminding a tasty aspect, it was necessary that the typography was also composed of letters
            visually focntioning when they are not put end to end (for the puzzle on the can to work).
          </p>
        </div>
...
export default {
  ...
  computed: {
    ...
    overlayImageSrc6() {
      return this.overlayShown6 ? "/image/alpha/canmock.jpg" : "/image/alpha/canmock.jpg";
    },
  },
  mounted() {
