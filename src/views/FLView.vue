    ...
    <div class="-mb-16 h-screen">
      ...
      <div class="flex justify-between">
        <div class="animate__animated animate__fadeIn p-4 text-sm uppercase">
          <p>Feelings lost in the fields.</p>
        </div>

        <div class="p-4 text-sm">
          <p class="animate__animated animate__fadeIn text-right">07/2023</p>
        </div>
      </div>
    </div>
      ...
      <div class="flex flex-col items-center">
        ...
        <div class="flex w-11/12 flex-col justify-between">
          <p class="reveal mt-6 text-justify text-xs transition-opacity duration-500">
            This work is a visual representation of melancholy through a dysfunctional couple dynamic taken to the extreme. The woman is
            depicted as ready to shoot the lost man and accepting his fate. The goal of this work was to create a metaphorical vision of
            pain and uncertainty, expressing the emotions that accompany this feeling.
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="hidden sm:block lg:hidden">
      <div class="flex gap-5">
        ...
        <div class="flex w-1/3 flex-col justify-between lg:w-1/2">
          ...
          <h2 class="reveal cursor-pointer text-6xl font-bold tracking-tight">Melancholy.</h2>
        </div>
      </div>
    </div>
      ...
      <div class="mt-24 flex flex-col">
        <div class="flex w-full flex-row-reverse items-center gap-6">
          ...
          <p class="reveal mt-6 w-1/2 px-3 text-justify text-xs duration-500">
            The choice of warm, pleasant colors for the canvas creates a stark contrast to the scene depicted, which is an action that is
            the opposite of these feelings. This has the effect of evoking a sense of loss and uncertainty in the viewer, as the work seems
            to suggest that pain can sometimes be hidden behind a pleasant and comfortable appearance.
          </p>
        </div>
...
export default {
  ...
  computed: {
    overlayImageSrc1() {
      return this.overlayShown1 ? "/image/FL/FL.jpg" : "/image/FL/FL.jpg";
    },
    overlayImageSrc2() {
      return this.overlayShown2 ? "/image/FL/FLzoom1.png" : "/image/FL/FLzoom1.png";
    },
    overlayImageSrc3() {
      return this.overlayShown3 ? "/image/FL/TEST.png" : "/image/FL/TEST.png";
    },
    overlayImageSrc4() {
      return this.overlayShown4 ? "/image/FL/FLzoom2.png" : "/image/FL/FLzoom2.png";
    },
    overlayImageSrc5() {
      return this.overlayShown5 ? "/image/FL/FLMan.png" : "/image/FL/FLMan.png";
    },
    overlayImageSrc6() {
      return this.overlayShown6 ? "/image/FL/FLzoom1.png" : "/image/FL/FLzoom1.png";
    },
  },
  mounted() {
