  ...
  <div class="mt-32 sm:ml-24 sm:mr-24">
    <div class="-mb-16 h-screen">
      ...
      <div class="h-4/6 bg-blue-400 sm:h-4/6">
        <img class="h-full w-full object-cover" src="/image/Cap/Cover.jpg" alt="Cap et Capuche Album" />
      </div>
      <div class="flex justify-between">
        <div class="animate__animated animate__fadeIn p-4 text-sm">
          <p>DEEMAX - CAP & CAPUCHE 02/2023</p>
        </div>
        <div class="p-4 text-sm">
          <p class="animate__animated animate__fadeIn text-center">Creation of the visual identity and artistic direction of the project</p>
        </div>
        <div class="p-4 text-sm">
          <p class="animate__animated animate__fadeIn text-right">COVER + MEDIA SUPPORT + ANIMATION CLIP</p>
        </div>
      </div>
    </div>
    ...
    <div class="block sm:hidden">
      ...
      <div class="flex flex-col items-center">
        <div class="mt-3 w-9/12">
          <img class="object-cover" src="/image/Cap/Cover.jpg" alt="Cap et Capuche Album" @click="showOverlay(1)" />
        ...
        <div class="flex w-11/12 flex-col justify-between">
          <p class="reveal mt-6 text-justify text-xs transition-opacity duration-500">
            ...
            necessary to determine the most effective composition for the cover, conveying the most emotion. I went for a contrast between
            the black representing Deemax and his team and an off-white allowing to add depth to the black, visual lightness, while
            recalling an old school aspect desired via the texture.
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="hidden sm:block lg:hidden">
      <div class="flex gap-5">
        <div class="w-2/3 lg:w-1/2">
          <img class="object-cover lg:w-3/4" src="/image/Cap/Cover.jpg" alt="Cap et Capuche Album" @click="showOverlay(1)" />
          <div class="overlay bg-black bg-opacity-95" v-if="overlayShown1">
        ...
        <div class="flex w-1/3 flex-col justify-between lg:w-1/2">
          <p class="reveal mt-6 text-justify text-xs opacity-100 duration-1000 lg:transition-opacity">
            For the release of the first project of the promising Parisian rapper Deemax, I was in charge of the entire art direction of the
            project. The goal was to create a strong imagery, reminding the old school aspect of Deemax's music, while being a subtle
            reminder of the subject : "cap & hood".
          </p>
          <h2 class="reveal cursor-pointer text-6xl font-bold tracking-tight">Art direction.</h2>
        </div>
      </div>
    </div>
    ...
    <div class="block lg:hidden">
      <div class="mt-24 flex flex-col">
        <div class="flex w-full flex-row-reverse items-center gap-6">
          <img class="h-52 w-1/2 object-cover" src="/image/Cap/MédiaDeemax.jpg" alt="Cap et Capuche Album" @click="showOverlay(2)" />
        ...
        <div class="flex w-full flex-row-reverse items-end gap-6">
          ...
          <img class="h-52 w-1/2 object-cover object-center" src="/image/Cap/DEEV8.jpg" alt="Cap et Capuche Album" @click="showOverlay(3)" />
    ...
    <div class="hidden lg:block">
      <div class="mt-40 flex flex-col">
        ...
        <div class="flex w-full flex-row-reverse items-end gap-6">
          <h2
            class="reveal w-1/2 animate-pulse cursor-pointer text-3xl font-bold tracking-tight opacity-0 hover:animate-none sm:text-5xl"
            @click="toggleDescription"
            @mouseover="showDescription"
            @mouseout="hideDescription"
          >
          ...
          <img class="h-52 w-1/2 object-cover object-center pr-32" src="/image/Cap/DEEV8.jpg" alt="Cap et Capuche Album" @click="showOverlay(3)" />
          <div class="overlay bg-black bg-opacity-95" v-if="overlayShown3">
    ...
    <div class="mx-auto w-11/12 items-center lg:hidden">
      <div class="mt-28 flex">
        <div class="w-1/2 pr-4">
          ...
          <img class="mb-6 w-full object-cover" src="/image/Cap/Tracklist.jpg" alt="Cap et Capuche Album" @click="showOverlay(5)" />
        ...
        <div class="w-1/2 pl-4">
          <img class="mb-6 w-full object-cover" src="/image/Cap/DEEM.jpg" alt="Cap et Capuche Album" @click="showOverlay(4)" />
          ...
          <img class="mt-6 mb-6 w-full object-cover" src="/image/Cap/DEEANIM.jpg" alt="Cap et Capuche Album" @click="showOverlay(6)" />
    ...
    <div class="hidden lg:block">
      <div class="mt-52 flex flex-col">
        <div class="flex w-full flex-row-reverse items-center gap-0">
          <img class="h-60 w-1/3 object-cover" src="/image/Cap/DEEM.jpg" alt="Cap et Capuche Album" @click="showOverlay(4)" />
          <div class="overlay bg-black bg-opacity-95" v-if="overlayShown4">
          ...
          <img class="h-60 w-1/3 object-cover object-top" src="/image/Cap/Tracklist.jpg" alt="Cap et Capuche Album" @click="showOverlay(5)" />
          <div class="overlay bg-black bg-opacity-95" v-if="overlayShown5">
        ...
        <div class="flex w-full flex-row-reverse items-end">
          ...
          <img class="h-60 w-1/3 object-cover object-center" src="/image/Cap/DEEANIM.jpg" alt="Cap et Capuche Album" @click="showOverlay(6)" />
          <div class="overlay bg-black bg-opacity-95" v-if="overlayShown6">
...
export default {
  ...
  computed: {
    overlayImageSrc1() {
      return this.overlayShown1 ? "/image/Cap/Cover.jpg" : "/image/Cap/Cover.jpg";
    },
    overlayImageSrc2() {
      return this.overlayShown2 ? "/image/Cap/MédiaDeemax.jpg" : "/image/Cap/MédiaDeemax.jpg";
    },
    overlayImageSrc3() {
      return this.overlayShown3 ? "/image/Cap/DEEV8.jpg" : "/image/Cap/DEEV8.jpg";
    },
    overlayImageSrc4() {
      return this.overlayShown4 ? "/image/Cap/DEEM.jpg" : "/image/Cap/DEEM.jpg";
    },
    overlayImageSrc5() {
      return this.overlayShown5 ? "/image/Cap/Tracklist.jpg" : "/image/Cap/Tracklist.jpg";
    },
    overlayImageSrc6() {
      return this.overlayShown6 ? "/image/Cap/DEEANIM.jpg" : "/image/Cap/DEEANIM.jpg";
    },
  },
  mounted() {
